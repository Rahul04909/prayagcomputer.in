...
try {
    ...
    $cat_stmt = $pdo->query("SELECT id, name FROM steno_exam_categories WHERE status = 1 ORDER BY name ASC");
    ...
    // Fetch tests with markers and filters
                ...
                <div class="card test-table-card">
                    <div class="card-header bg-white p-3">
                        <div class="row align-items-center">
                            <div class="col-md-2">
                                <h3 class="card-title" style="font-weight:700; color:#343a40; margin:0;">Steno Tests (<?= $total_results ?>)</h3>
                            </div>
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <?php if ($category_filter || $language_filter || $level_filter || $search_filter): ?>
                                                <a href="manage-steno-tests.php" class="btn btn-outline-secondary" title="Clear Filters"><i class="fas fa-times"></i></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="col-md-2 text-end">
                                <a href="add-steno-test.php" class="btn btn-sm btn-success shadow-sm w-100">
